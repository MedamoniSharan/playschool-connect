...
export default function Navbar() {
  const { currentUser, notifications, getChildrenForParent } = useApp();
  ...
  return (
    <header className="flex h-20 items-center justify-between px-4 lg:px-8 dashboard-modern print:hidden w-full max-w-[1600px] mx-auto mt-2">
      <div className="flex items-center gap-4 flex-1 ml-16 lg:ml-0">
      ...
      <div className="flex items-center gap-4 lg:gap-6">
        <Link
          to="/notifications"
          className="relative flex h-10 w-10 items-center justify-center rounded-full border border-dash-subtle bg-dash-surface text-dash-ink hover:bg-dash-canvas hover:border-dash-ring transition-colors shadow-sm"
